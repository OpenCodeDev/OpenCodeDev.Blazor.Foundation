...
namespace OpenCodeDev.Blazor.Foundation.Extensions.ValidatorAttributes
{
    ...
    public class AbideAlphaNumericAttribute : ValidationAttribute
    {
        public bool AcceptsNull { get; set; } = false;
        public AbideAlphaNumericAttribute(bool acceptsNull = false)
        {
        ...
        public override bool IsValid(object value)
        {
            ...
            var regex = new Regex(Abide.ALPHA_NUMERIC);
